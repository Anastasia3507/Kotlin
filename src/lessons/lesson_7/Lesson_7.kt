...
fun main() {
    ...
    */
    ...
    /*  Задание 2
    2.1 Создайте структуру Car со следующими свойствами: model: String, power: Int, description: String
    Свойство description должно возвращать сообщение с названием автомобиля и его мощность в лошадиных силах.
    Так же необходимо реализовать метод increasePower, который должен увеличить мощность автомобиля на заданное
    количество лошадиных сил.
    */

    /*:
    2.2 Создайте экземпляр структуры и инициализируйте её свойства. Выведите значение свойства description на консоль,
    а затем вызовите метод increasePower. Снова выведите значение свойства description на консоль.
    */
}
